...
const config: Config = {
  ...
  // ✅ Correct GitHub Pages info
  url: 'https://Mailakhan67.github.io',
  baseUrl: '/ai-robotics/',
  organizationName: 'Mailakhan67', // your GitHub username
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Physical AI & Humanoid Robotics',
      logo: {alt: 'Robotics Course Logo', src: 'img/logo.svg'},
      items: [
      ...
      links: [
        {
          ...
          items: [
            ...
            {label: 'ROS 2 Module', to: '/module1-ros2/ros2-overview'},
            {label: 'Isaac Platform', to: '/module3-isaac/isaac-sim'},
          ],
        },
        {
          title: 'Resources',
